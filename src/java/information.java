        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                Class.forName("com.mysql.cj.jdbc.Driver");
                 ...
                 PreparedStatement pst=con.prepareStatement("insert into donarInformation(state,district,hospitalName,hospitalAddress,name,MobileNumber,email,Address,gender,age,weight,bloodgroup,bloodquantity)values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
                 pst.setString(1, state);
                 pst.setString(2, district);
                 pst.setString(3, HName);
                 pst.setString(4, HAddress);
                 pst.setString(5, name);
                 pst.setString(6, Mnumber);
